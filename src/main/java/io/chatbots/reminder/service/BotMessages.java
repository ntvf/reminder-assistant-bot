...
public final class BotMessages {
    ...
    public enum Key {
        ...
        REMINDER_FIRED, TZ_ASSUMED, PROCESSING,
    ...
    private static final Map<Key, String> EN = Map.ofEntries(
        ...
        Map.entry(Key.TZ_ASSUMED, "🕐 I assumed your timezone is <b>%s</b> — reminders will fire in that zone. Change it below if that's wrong."),
    ...
    private static final Map<Key, String> RU = Map.ofEntries(
        ...
        Map.entry(Key.TZ_ASSUMED, "🕐 Я предположил, что ваш часовой пояс — <b>%s</b>. Напоминания будут срабатывать в нём. Если это не так, измените его ниже."),
        Map.entry(Key.REMINDER_FIRED, "⏰ %s"),
    ...
    private static final Map<Key, String> DE = Map.ofEntries(
        ...
        Map.entry(Key.TZ_ASSUMED, "🕐 Ich habe Ihre Zeitzone als <b>%s</b> angenommen — Erinnerungen richten sich danach. Ändern Sie sie unten, falls das falsch ist."),
        Map.entry(Key.REMINDER_FIRED, "⏰ %s"),
    ...
    private static final Map<Key, String> FR = Map.ofEntries(
        ...
        Map.entry(Key.TZ_ASSUMED, "🕐 J'ai supposé que votre fuseau horaire est <b>%s</b> — les rappels s'y référeront. Modifiez-le ci-dessous si ce n'est pas le cas."),
        Map.entry(Key.REMINDER_FIRED, "⏰ %s"),
    ...
    private static final Map<Key, String> ES = Map.ofEntries(
        ...
        Map.entry(Key.TZ_ASSUMED, "🕐 He supuesto que su zona horaria es <b>%s</b>; los recordatorios usarán esa zona. Cámbiela abajo si no es correcto."),
        Map.entry(Key.REMINDER_FIRED, "⏰ %s"),
    ...
    private static final Map<Key, String> PT = Map.ofEntries(
        ...
        Map.entry(Key.TZ_ASSUMED, "🕐 Assumi que o seu fuso horário é <b>%s</b> — os lembretes usarão esse fuso. Altere-o abaixo se estiver errado."),
        Map.entry(Key.REMINDER_FIRED, "⏰ %s"),
    ...
    private static final Map<Key, String> IT = Map.ofEntries(
        ...
        Map.entry(Key.TZ_ASSUMED, "🕐 Ho ipotizzato che il suo fuso orario sia <b>%s</b>: i promemoria lo useranno. Lo cambi qui sotto se non è corretto."),
        Map.entry(Key.REMINDER_FIRED, "⏰ %s"),
    ...
    private static final Map<Key, String> TR = Map.ofEntries(
        ...
        Map.entry(Key.TZ_ASSUMED, "🕐 Saat diliminizi <b>%s</b> olarak varsaydım — hatırlatmalar buna göre çalışacak. Yanlışsa aşağıdan değiştirin."),
        Map.entry(Key.REMINDER_FIRED, "⏰ %s"),
    ...
    private static final Map<Key, String> PL = Map.ofEntries(
        ...
        Map.entry(Key.TZ_ASSUMED, "🕐 Założyłem, że Państwa strefa czasowa to <b>%s</b> — przypomnienia będą jej używać. Proszę zmienić ją poniżej, jeśli to nieprawidłowe."),
        Map.entry(Key.REMINDER_FIRED, "⏰ %s"),
    ...
    private static final Map<Key, String> UK = Map.ofEntries(
        ...
        Map.entry(Key.TZ_ASSUMED, "🕐 Я припустив, що ваш часовий пояс — <b>%s</b>. Нагадування спрацьовуватимуть саме в ньому. Якщо це не так, змініть його нижче."),
        Map.entry(Key.REMINDER_FIRED, "⏰ %s"),
